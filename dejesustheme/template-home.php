...
<div class="jumbotron bg-jumbo-home bg-jumbotron">
    <div class="col-md-6 text-center float-md-right pt-5 mt-5 pl-md-5 ml-md-5">
...
<div class="container-fluid bg-lawyer" id="About">
    <div class="row mt-5 pt-4">
        <div class="col-md-6 m-md-5 px-md-5 py-md-3">
            <h1 style="color: #1e3455">Legal Professionalism</h1>
...
<div class="container-fluid" style="background-color:#1e3455;">
...
<div class="container-fluid cover-lawyer pt-5">
    <h1 class="mt-5 text-center" style="color:#212529;">OUR ATTORNEYS</h1>
    ...
    <div class="row">
        <div class="col-md-3 order-md-3 pl-md-5">
                ...
                <div class="row pt-5">
                    <div class="col-md-4 border-services litigation">
                        <div class="overlay p-4">
                            <h2 class="pb-2 pt-4">Litigation</h2>
                    ...
                    <div class="col-md-4 border-services corporate-practice">
                        <div class="overlay p-4">
                            <h2 class="pb-2 pt-4">Corporate Practice</h2>
                    ...
                    <div class="col-md-4 border-services immigration">
                        <div>
                            <div class="overlay p-4 mr-3">
                                <h2 class="pb-2 pt-5">Immigration</h2>
                    ...
                    <div class="col-md-4 border-services taxation">
                        <div class="overlay p-4">
                            <h2 class="pb-2 pt-4">Taxation</h2>
                    ...
                    <div class="col-md-4 border-services special-projects">
                        <div class="overlay p-4">
                            <h2 class="pb-2 pt-3">Special Projects</h2>
...
<div class="container-fluid pb-2 bg-post">
